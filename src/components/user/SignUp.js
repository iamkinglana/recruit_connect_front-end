...
const SignUp = ({ setUser, setCurrentForm }) => {
//   const navigate = useNavigate()
    ...
    <div className="signup">
      <div className="signup-container">
        <div className="signup-welcome-page">
          {/* <img scr={image} alt="image" className="signup-img" /> */}
          <div className="welcome-text">
            ...
            <p className="welcome-text-description">
              Sign up now and get access to our shopping website where you can
              get your favourite clothing at affordable prices
            </p>

            <div className="signup-wrapper">
              <p className="signup-text">Have an account?</p>
              {/* <button><Link to={'/log-in'}>Log in here</Link></button> */}
            </div>
          </div>
        </div>
